...
| 🪐&nbsp;**`autoencoder_normalisation.ipynb`** | Notebook for the autoencoder normalisation approach for the preprocessed EEA dataset to estimate utility provided by each motor energy type. |
